...
`
    ...
    else if(input === resposta[7]){
        enigma.textContent = "VOCÊ FOI ESCOLHIDO"
        document.querySelector(".enfase").textContent = "Entraremos em contato."
        documento.querySelector(".btn").textContent = "Sempre observando"
    }
    else  {
